...
delta_init[,,,] <-
  ...
  if (test_pop == 2 && i == 2 && k == 1 && l == 1) test_ty / sum(n_symp[i,,k,l]) else
  # pregnant women
  if (test_pop == 3 && i == 2 && l == 2) test_ty / sum(n_symp[i,,,l]) else
  # fsw
  if (test_pop == 4 && i == 2 && j == 3) test_ty / sum(n_symp[i,j,,]) else
  # male (any risk and age)
  if (test_pop == 5 && i == 1 && l == 1) test_ty / sum(n_symp[i,,,l]) else
  # male high risk (any age)
  if (test_pop == 6 && i == 1 && j == 3 && l == 1) test_ty / sum(n_symp[i,j,,l]) else
  # no one tested
  0
...
tau_hc[,,,] <-
  ...
  # agyw all
  if (test_pop == 1 && i == 2 && k == 1 && l == 1) test_th / sum(N_hc[i,,k,l]) else
  # agyw sexually active
  if (test_pop == 2 && i == 2 && k == 1 && l == 1) test_th / sum(N_hc[i,,k,l]) else
  # pregnant women
  if (test_pop == 3 && i == 2 && l == 2) test_th / sum(N_hc[i,,,l]) else
  # fsw
  if (test_pop == 4 && i == 2 && j == 3) test_th / sum(N_hc[i,j,,]) else
  # male (any risk and age)
  if (test_pop == 5 && i == 1 && l == 1) test_th / sum(N_hc[i,,,l]) else
  # male high risk (any age)
  if (test_pop == 6 && i == 1 && j == 3 && l == 1) test_th / sum(N_hc[i,j,,l]) else
  # no one tested
  0

# tau_hc can be > 1 as it is a rate (i.e. test multiple times per year)
